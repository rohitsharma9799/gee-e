...
public class DraftVideos_Adapter extends RecyclerView.Adapter<DraftVideos_Adapter.CustomViewHolder > {
    ...
    public DraftVideos_Adapter(Context context, ArrayList<DraftVideo_Get_Set> dataList, OnItemClickListener listener) {
    ...
    class CustomViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(final int position, final DraftVideo_Get_Set item, final OnItemClickListener listener) {
