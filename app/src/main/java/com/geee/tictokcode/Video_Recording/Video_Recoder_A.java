...
import com.geee.R;
import com.geee.tictokcode.SegmentProgress.ProgressBarListener;
import com.geee.tictokcode.SegmentProgress.SegmentedProgressBar;
...
import com.geee.tictokcode.SoundLists.SoundList_Main_A;
                    ...
                    if(file.exists()) {
                        try {
                            ...
                            if (isVideo && file.length() > 3000) {
                                Log.d("respfdfdffd", videopaths.get(i));
...
//        .setCompressOption(new CompressOption()) //empty constructor for default compress option
                            .setHideSeekBar(true)
                            .setDestination(Variables.app_hided_folder)  //default output path /storage/emulated/0/DOWNLOADS
                            .start(this);
