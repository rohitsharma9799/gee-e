...
public class ApiRequest {
    ...
    public static void Call_Api (final Context context, final String url, JSONObject jsonObject,
        ...
        com.geee.tictokcode.SimpleClasses.Variables.sharedPreferences=context.getSharedPreferences(Variables.pref_name,MODE_PRIVATE);
