    ...
    public class send extends AsyncTask<MultiPartRequest, Void, String> {
        ...
        protected String doInBackground(MultiPartRequest... multiPartRequests) {
            ...
            try {
                ...
                headerBuilder.add("fb_id",sharedPreferences.getString(Variables.u_id,"0"));
              ...
              //  Log.d("sdasdsdasdadsads",requestBody.toString());
                Log.d("sdasdadsads",sharedPreferences.getString(Variables.u_id,"0"));
                Log.d("sdasdsdaadsads",sharedPreferences.getString(Variables.api_token,""));
                Log.d("sdasdsdasdads",sharedPreferences.getString(Variables.device_id,""));
                Log.d("urkkk",Variables.uploadVideo);
              //  Log.d("udfdfdfrkkk",requestBody.toString());
