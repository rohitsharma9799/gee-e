package com.geee.tictokcode.Profile;
...
import com.geee.tictokcode.Profile.Liked_Videos.Liked_Video_F;
import com.geee.tictokcode.Profile.Private_Videos.PrivateVideo_F;
import com.geee.tictokcode.Profile.UserVideos.UserVideo_F;
import com.geee.tictokcode.See_Full_Image_F;
...
import com.geee.tictokcode.Video_Recording.DraftVideos.DraftVideos_A;
        ...
        try {
            ...
            if(code.equals("200")){
                ...
                Picasso.get()
                        .load(pic_url)
                        .centerCrop()
                        .placeholder(context.getResources().getDrawable(R.drawable.ic_gallery_icon)).resize(200,200)
                        .into(imageView);
