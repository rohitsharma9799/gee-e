...
public class Sounds_Adapter extends RecyclerView.Adapter<Sounds_Adapter.CustomViewHolder >  {
    ...
    public Sounds_Adapter(Context context, ArrayList<Sound_catagory_Get_Set> arrayList, OnItemClickListener listener) {
...
class Sound_Items_Adapter extends RecyclerView.Adapter<Sound_Items_Adapter.CustomViewHolder > {
    ...
    public Sound_Items_Adapter(Context context, ArrayList<Sounds_GetSet> arrayList, OnItemClickListener listener) {
        this.context = context;
        datalist= arrayList;
        this.listener=listener;
    }
