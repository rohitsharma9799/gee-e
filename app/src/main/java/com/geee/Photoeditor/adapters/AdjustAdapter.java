...
public class AdjustAdapter extends RecyclerView.Adapter<AdjustAdapter.ViewHolder> {
    ...
    public class AdjustModel {
        ...
        public void setSeekBarIntensity(PhotoEditor photoEditor, float mFloat, boolean mBoolean) {
            ...
            if (photoEditor != null) {
                ...
                Log.i("int=",""+this.intensity);
                Log.i("booleanmsc=",""+this.index);
    ...
    public AdjustAdapter(Context mContext, AdjustListener mAdjustListener, PhotoEditor mPhotoEditor) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
        ...
        if (this.selectedFilterIndex==6){
            Toast.makeText(context, "ok", Toast.LENGTH_SHORT).show();
          // getCurrentAdjustModel().setSeekBarIntensity(mPhotoEditor, 82 / 100, true);
           // photoEditor.setFilterIntensityForIndex(this.intensity, this.index, mBoolean);
            mPhotoEditor.setFilterIntensityForIndex(0.39999998f, 0, true);
            final Handler handler = new Handler();
            handler.postDelayed(new Runnable() {
                @Override
                public void run() {
                    // Do something after 5s = 5000ms
                    mPhotoEditor.setFilterIntensityForIndex(1.3599999f, 1, true);
                }
            }, 500);
            ...
            handler2.postDelayed(new Runnable() {
                ...
                public void run() {
                    // Do something after 5s = 5000ms
                   // mPhotoEditor.setFilterIntensityForIndex(7.0000005f, 3, true);
                }
            }, 1000);
        }

        if (this.selectedFilterIndex==7){
    ...
    private void init() {
        ...
        this.adjustModelList.add(new AdjustModel(6, this.context.getString(R.string.autoenhance), "Auto Enhance", this.context.getDrawable(R.drawable.magictool), -2.0f, 0.0f, 2.0f));
        this.adjustModelList.add(new AdjustModel(7, this.context.getString(R.string.facetuner), "Face-Tuner", this.context.getDrawable(R.drawable.ic_acen), -2.0f, 0.0f, 2.0f));
