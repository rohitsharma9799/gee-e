...
import com.geee.Photoeditor.adapters.ColorDripAdapter;
import com.geee.Photoeditor.adapters.DripAdapter;
import com.geee.Photoeditor.adapters.DripBackgroundAdapter;
...
import com.geee.Photoeditor.listener.BackgroundItemListener;
...
public class DripActivity extends BaseActivity implements LayoutItemListener, BackgroundItemListener,
        ColorDripAdapter.BackgroundColorListener{
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.findViewById(R.id.imageViewStyle).setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                ...
                imageViewStyle.setColorFilter(getResources().getColor(R.color.mainColor));
        ...
        this.findViewById(R.id.imageViewBg).setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                ...
                imageViewColor.setBackgroundResource(R.drawable.background_unslelected);
                imageViewStyle.setBackgroundResource(R.drawable.background_unslelected);
                imageViewBg.setColorFilter(getResources().getColor(R.color.mainColor));
                imageViewColor.setColorFilter(getResources().getColor(R.color.white));
                imageViewStyle.setColorFilter(getResources().getColor(R.color.white));
                recyclerViewStyle.setVisibility(View.GONE);
    ...
    private void initBitmap() {
        if (faceBitmap != null) {
            ...
            mainBitmap = Bitmap.createScaledBitmap(DripUtils.getBitmapFromAsset(DripActivity.this, "drip/style/white.webp"), 512, selectedBitmap.getHeight(), true);
    ...
    @Override
    public void onBackgroundColorSelected(int i, ColorDripAdapter.SquareView squareView) {
...
//            Exception e = new UnsupportedOperationException();
        ...
        protected void onPostExecute(Bitmap bitmap) {
            ...
            Intent intent = new Intent(DripActivity.this, PhotoEditorActivity.class);
