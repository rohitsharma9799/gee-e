...
public class FiltersListFragment extends Fragment implements ThumbnailsAdapter.ThumbnailsAdapterListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        prepareThumbnail(FiltersA.croppedImage);
    ...
    public void prepareThumbnail(final Bitmap bitmap) {
        Runnable r = new Runnable() {
            public void run() {
                ...
                if (bitmap == null) {
                    //Methods.toast_msg(getContext(),"null");
                    thumbImage = BitmapUtils.getBitmapFromAssets(getActivity(), FiltersA.IMAGE_NAME, 100, 100);
                } else {
