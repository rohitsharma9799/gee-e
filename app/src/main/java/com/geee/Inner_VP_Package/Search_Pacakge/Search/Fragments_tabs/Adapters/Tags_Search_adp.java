...
public class Tags_Search_adp extends RecyclerView.Adapter<Tags_Search_adp.ViewHolder> {

    Context context;
    List<Account_search_DM> accounts;

    public Tags_Search_adp(Context ctx, List<Account_search_DM> accounts) {
        this.context = ctx;
    ...
    @NonNull
    @Override
    public Tags_Search_adp.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.tag_search_item, null);
        return new Tags_Search_adp.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull Tags_Search_adp.ViewHolder viewHolder, int i) {
