...
public class StoryAdapter extends RecyclerView.Adapter<StoryAdapter.ViewHolder> {
    ...
    public StoryAdapter.onItemLongClickListener onItemLongClickListener;
    Context context;
    List<ShowStoryDM> storiesArr;
    String userProfileResponse;
    public StoryAdapter(Context ctx, List<ShowStoryDM> arrayList, StoryAdapter.OnItemClickListener listener, StoryAdapter.onItemLongClickListener onItemLongClickListener) {
        this.context = ctx;
    ...
    public StoryAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_story_layout, null);
        return new StoryAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull StoryAdapter.ViewHolder viewHolder, @SuppressLint("RecyclerView") int i) {
